...
# ***Test Cases***
# Run Normal P-Loan Loan Type Test Cases
#     Normal Loan Type Sensitivity    ${NORMAL_P_LOAN_LOAN_TYPE_TEST_CASES}

# Run Normal Nano-Loan Loan Type Test Cases
#     Normal Loan Type Sensitivity    ${NORMAL_NANO_LOAN_LOAN_TYPE_TEST_CASES}

# ***Keywords***
# Normal Loan Type Sensitivity
#     [Arguments]    ${scenario}
...
#     Log    Step 7: Revolving Loan Type Test Cases...
#     @{failures}=    Create List
#     FOR    ${case}    IN    @{scenario['cases']}
#         Log    --- Running Loan Type Case ---
#         Answer Questions    ${session_id}    ${case_id}    ${case['answers']}
#         Sleep    5s
#         ${case_detail}    ${actual_max_value}    ${actual_min_value}=    Check Revolving Loan Type Updated    ${session_id}    ${case_id}    ${case['expected']['revolving_credit_limit']}
...
#         Fail    ${failures_count} Revolving Loan Type test case(s) failed:\n${all_failures}
#     END
#     Log    Step 7: Revolving Loan Type Test Cases completed.