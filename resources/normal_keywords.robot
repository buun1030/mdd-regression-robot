...
Resource    ../resources/mambu_keywords.robot
...
Initial Normal Workflow
    ...
    Log    Step 6: Verifying Case Details...
    Sleep    12s
...
Mambu Workflow
    ...
    Disburse Loan    ${loan_id}    Disbursed via API    ${fee_amount}
    Make Loan Repayment    ${loan_id}    ${repayment_amount}    Repayment via API